...
def parse_listing(keyword, place, geolocator):
    """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for results in listings:
                    ...
                    '''
                    address = "{} {} {} {}".format(street, locality, region, zipcode)
                    ...
                    if location is not None:
                        business_details['lat'] = location.latitude
                        business_details['long'] = location.longitude
                    else:
                        business_details['lat'] = ''
                        business_details['long'] = ''

                    ordered_tmp = collections.OrderedDict(sorted(business_details.items()))
                    scraped_results['competitors'].append(ordered_tmp)
